...
Future<void> showAppErrorDialog(BuildContext context, Object error) {
  return showAppErrorMessageDialog(context, formatAppErrorMessage(context, error));
}

/// Pre-formatted message (e.g. deposit/withdraw friendly strings).
Future<void> showAppErrorMessageDialog(BuildContext context, String message) async {
  ...
  await showDialog<void>(
    ...
    builder: (ctx) => AlertDialog(
      ...
      content: SingleChildScrollView(
        child: Text(message, style: TextStyle(color: Theme.of(ctx).colorScheme.onSurface)),
      ),
      actions: [
        TextButton(
